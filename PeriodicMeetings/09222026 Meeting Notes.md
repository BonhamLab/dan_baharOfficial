...
[Link to last meeting notes](./YYYY-MM-DD.md)

- [x] Familiarized myself with Jupyter and python
- [x] Explored + experimented with bioPython an its documentaion
...
- [ ] Complete nhAa protocol with 50 genomes --> Make code more efficient if needed --> Complete nhAa protocol with all 4098 genomes
